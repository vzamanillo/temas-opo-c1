...
* Garantizar la neutralidad tecnológica: Asegurar que las decisiones técnicas no discriminen a los ciudadanos en función de su software.
* Eficiencia en el servicio: Evitar la duplicidad de datos y facilitar la reutilización de sistemas y aplicaciones.
...
Las NTI desarrollan aspectos específicos del ENI para asegurar su implementación práctica. Son de obligado cumplimiento y cubren áreas críticas como:
   ...
   2. Expediente Electrónico: Estructura para el intercambio de expedientes completos.
   3. Digitalización de Documentos: Formatos y estándares para pasar papel a digital.
   4. Política de Firma y Certificados: Reglas para el uso de firmas electrónicas.
   5. Catálogo de Estándares: Lista de formatos y protocolos recomendados para evitar barreras tecnológicas.
   6. Reutilización de Recursos de Información: Condiciones para abrir datos públicos (Open Data).
   7. Modelo de Datos: Esquemas comunes para el intercambio de asientos registrales y datos de intermediación.
